...
#define F0R_COLOR_MODEL_PACKED32 2
	 ...
	 */
	__declspec(dllexport) void f0r_get_plugin_info(f0r_plugin_info_t* info);
...
#define F0R_PARAM_STRING  4
	 ...
	 */
	__declspec(dllexport) typedef void* f0r_instance_t;
	 ...
	 * \see f0r_update2
	 */
	 __declspec(dllexport) void f0r_update(f0r_instance_t instance,
		double time, uint32_t* inframe, uint32_t* outframe);
	 ...
	 * \see f0r_update
	 */
	 __declspec(dllexport) void f0r_update2(f0r_instance_t instance,
		double time,
